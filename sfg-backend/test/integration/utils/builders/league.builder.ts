import { CreateLeagueDto } from 'generated/graphql';

export class LeagueDataBuilder {
  private data: Partial<CreateLeagueDto> = {};

  withSeasonId(seasonId: number): this {
  ...
  withData(data: Partial<CreateLeagueDto>): this {
    this.data = { ...this.data, ...data };
    return this;
  }

  build(): CreateLeagueDto {
    return {
      seasonId: 1,
